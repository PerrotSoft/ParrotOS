...
import { FEED_AD_EVERY_N } from '../lib/siteConfig';
      ...
      <div className="create-ch-popup" style={{ maxWidth: '480px' }} onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleFormSubmit} className="create-ch-form">
          ...
          <div className="field-group" style={{ marginTop: '8px', padding: '12px', background: 'rgba(99,102,241,0.08)', borderRadius: '10px', border: '1px solid rgba(99,102,241,0.2)' }}>
            ...
            <p style={{ margin: '10px 0 4px', fontSize: '12px', color: '#ccc' }}>ID площадок (необязательно — берутся во вкладке «Разработчик» → «Мои площадки»; без них статистика по показам идёт в общий, не привязанный к конкретной площадке учёт):</p>
                    ...
                    <React.Fragment key={video.id}>
                      ...
                      {(index + 1) % FEED_AD_EVERY_N === 0 && (
                        <div className="wavy-video-card">
                          ...
                          <div className="card-info">
                            <h3>Реклама</h3>
                            <p className="card-channel">FireSoft Ads</p>
                          </div>
                        </div>
                      )}
                    </React.Fragment>
