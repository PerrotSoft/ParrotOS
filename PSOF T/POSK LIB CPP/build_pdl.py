...
def build_pdl():
    ...
    gpp_cmd = (
        "g++ -ffreestanding -fshort-wchar -fPIC -m64 -fno-exceptions "
        "-fno-asynchronous-unwind-tables -O1 -c main.cpp -o main.o"
    )
    print(f"[{gpp_cmd}]")
    if subprocess.run(gpp_cmd, shell=True).returncode != 0:
        print("Ошибка: сбой компиляции main.cpp!")
        sys.exit(1)
    ...
    # export_table_offset, вычисленный в main.cpp как sizeof(PDL_Header),
